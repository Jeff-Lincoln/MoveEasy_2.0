...
const CustomDrawerContent = (props: any) => {
    ...
    const goToProfilePage = () => {
        router.replace('/(authenticated)/(tabs)/Profile/Profile');
    };
    ...
    return (
        <View style={styles.drawerContainer}>
            ...
            <Dialog.Container visible={dialogOpen} contentStyle={styles.dialogContent}>
                <View style={styles.dialogIconContainer}>
                    <AntDesign name="exclamationcircleo" size={40} color="#F39C12" />
                </View>
...
//     if (typeof isSignedIn !== 'boolean') {
//         return null; // Prevent rendering if auth state is not ready
//     }
