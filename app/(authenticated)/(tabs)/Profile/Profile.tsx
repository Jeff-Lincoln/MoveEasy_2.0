    ...
    <>
          ...
          <View style={styles.profileContent}>
            <View style={styles.profileImageContainer}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                  Alert.alert('Coming Soon', 'Profile photo update feature coming soon!');
                }}
              >
        ...
        <View style={styles.section}>
          ...
          {paymentHistory.length > 0 ? (
            ...
            <View style={styles.noDataContainer}>
              <MaterialCommunityIcons name="truck-delivery" size={50} color="#666" />
      ...
      {showScrollToTop && (
        ...
        >
          ...
          >
            <MaterialIcons name="keyboard-arrow-up" size={30} color="#FFFFFF" />
          </TouchableOpacity>
        </Animated.View>
      )}
    </>
